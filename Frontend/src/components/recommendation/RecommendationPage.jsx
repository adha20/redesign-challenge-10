    ...
    <div className="w-full bg-white relative flex flex-col items-center pt-[30px] lg:pt-[50px] pb-[60px] lg:pb-[100px] min-h-[calc(100vh-69px)] px-[20px] lg:px-0">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-[1080px] mx-auto">
        ...
        <div className="mt-[40px] lg:mt-[60px] flex flex-col items-center gap-[24px] lg:gap-[32px] w-full">
          ...
          {/* Usia */}
          <div className="w-full lg:w-[709px] flex flex-col gap-[8px] relative z-30">
            <label className="text-[16px] lg:text-[21px] text-light-black font-normal leading-[1.5]">Usia</label>
            <div 
            ...
            >
              <p className={`text-[16px] lg:text-[21px] ${selected.usia.length === 0 ? 'opacity-50 text-[#1a1a1a]' : 'text-[#1a1a1a]'}`}>
            ...
            {/* Dropdown Menu */}
            <div className={`absolute top-[85px] lg:top-[100px] left-0 w-full bg-[#f0f0f0] rounded-[24px] shadow-md transition-all duration-300 origin-top overflow-hidden z-10 ${dropdowns.usia ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'}`}>
          ...
          {/* Genre */}
          <div className="w-full lg:w-[709px] flex flex-col gap-[8px] relative z-20">
            <label className="text-[16px] lg:text-[21px] text-light-black font-normal leading-[1.5]">Genre (bisa pilih lebih dari 1)</label>
            <div 
          ...
          {/* Platform */}
          <div className="w-full lg:w-[709px] flex flex-col gap-[8px] relative z-10">
            <label className="text-[16px] lg:text-[21px] text-light-black font-normal leading-[1.5]">Platform</label>
            <div 
            ...
            {/* Dropdown Menu */}
            <div className={`absolute top-[85px] lg:top-[90px] left-0 w-full bg-[#f0f0f0] rounded-[24px] shadow-md transition-all duration-300 origin-top overflow-hidden z-10 ${dropdowns.platform ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'}`}>
              <div className="flex flex-col py-[16px]">
          ...
          {/* Tombol Cari */}
          <div className="mt-[20px] lg:mt-[30px] w-full lg:w-[709px]">
            <Button 
