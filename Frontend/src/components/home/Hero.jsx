...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[550px] lg:min-h-[722px] bg-gradient-to-b from-dblue-start to-dblue-end flex flex-col lg:block">
      ...
      <div className="relative w-[calc(100%-32px)] lg:w-[calc(100%-45px)] h-[500px] lg:h-[722px] mx-auto bg-white rounded-bl-[50px] lg:rounded-bl-[150px] rounded-br-[50px] lg:rounded-br-[150px] overflow-hidden z-10 shrink-0 mt-[16px] lg:mt-0">
        ...
        <div className="relative w-full lg:w-[1235px] h-full mx-auto">
          ...
          {/* Teks & Pencarian */}
          <div className="absolute top-[30px] lg:top-[45px] left-1/2 -translate-x-1/2 flex flex-col items-center w-full z-30 px-[16px] lg:px-0">
            <div className="text-center w-full max-w-[779px] flex flex-col gap-[8px] lg:gap-[10px]">
              <h1 className="font-bold text-[32px] lg:text-[47px] leading-[1.2] bg-clip-text text-transparent bg-gradient-to-b from-dblue-start to-dblue-end pb-[10px] -mb-[10px]">
                Cek Rating Gim Anda!
              </h1>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-[240px] lg:top-[295px] w-[90%] lg:w-[524px] h-[220px] lg:h-[318px] rounded-[24px] lg:rounded-[36px] shadow-custom-float z-10 overflow-hidden">
            <img alt="Hero Center" className="w-full h-full object-cover" src={imgImage6} />
          </div>

          {/* Gambar Kiri Miring (Image 2) */}
          <div className="hidden lg:flex absolute left-[139px] top-[494px] w-[555px] h-[354px] z-20 items-center justify-center pointer-events-none">
          ...
          <div className="hidden lg:flex absolute left-[517px] top-[522px] w-[575px] h-[400px] z-20 items-center justify-center pointer-events-none">
