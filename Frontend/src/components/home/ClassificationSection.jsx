  ...
  return (
    <section className="w-full bg-white pt-[50px] pb-[100px] flex flex-col items-center relative overflow-hidden">
      ...
      <div className="flex flex-col gap-[10px] items-center text-center px-4 max-w-[1015px] mx-auto w-full">
        <h2 className="text-[47px] font-bold leading-[1.2] bg-clip-text text-transparent bg-gradient-to-b from-[#ce2323] to-[#681212] pb-[10px] -mb-[10px]">
          ...
          {extendedClassifications.map((item) => (
            ...
            >
              ...
              <div className="flex flex-col gap-[8px] flex-1">
                <h3 className="text-[36px] text-center w-full font-bold leading-[1.2] bg-clip-text text-transparent bg-gradient-to-b from-[#ce2323] to-[#681212] pb-[10px] -mb-[10px]">
                  {item.title}
                </h3>
